...
<head>
    ...
    * {
    ...
    .stat-card.total::before { background: var(--gray-dark); }
    .stat-card.nova::before { background: var(--danger); }
    .stat-card.lida::before { background: var(--warning); }
    .stat-card.respondida::before { background: var(--success); }
    ...
    .message-item[data-status="nova"]::before { background: var(--danger); }
    .message-item[data-status="lida"]::before { background: var(--warning); }
    .message-item[data-status="respondida"]::before { background: var(--success); }
    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="admin-mensagens" class="nav-link active">
        ...
        <main class="admin-main">
            ...
            <div class="container">
                ...
                <div class="toolbar">
                    ...
                    <input type="text" class="search-box" placeholder="Buscar por nome, email ou mensagem..." id="searchBox">
                </div>
                ...
                <div class="messages-list" id="messagesList">
                    ...
                    <?php else: ?>
                        <?php foreach ($mensagens as $msg): ?>
                            <div class="message-item" data-status="<?php echo $msg['status']; ?>" data-search="<?php echo strtolower($msg['nome'] . ' ' . $msg['sobrenome'] . ' ' . $msg['email'] . ' ' . $msg['mensagem']); ?>">
                                ...
                                <div class="message-header">
                                    ...
                                    <div class="status-controls">
                                        <select class="status-select" onchange="updateStatus('<?php echo $msg['id']; ?>', this.value)">
                                            <option value="nova" <?php echo $msg['status'] === 'nova' ? 'selected' : ''; ?>>Nova</option>
                                            <option value="lida" <?php echo $msg['status'] === 'lida' ? 'selected' : ''; ?>>Lida</option>
