...
<head>
    <meta charset="UTF-8">
    <meta n    /* Responsividade das categorias */
    ...
    .featured-products .product-card {
        width: 100% !important;
        height: 450px !important; /* Altura fixa para uniformidade */
    ...
    .featured-products .product-image {
        width: 100% !important;
        height: 250px !important; /* Altura fixa para imagens */
        overflow: hidden !important;
    ...
    .featured-products .product-info h3 {
        ...
        height: 48px !important; /* Altura fixa para títulos */
        overflow: hidden !important;
    ...
    .featured-products .product-info p {
        ...
        height: 40px !important; /* Altura fixa para descrição */
        overflow: hidden !important;
        display: -webkit-box !important;
        -webkit-line-clamp: 2 !important;
        line-clamp: 2 !important;
                        ...
                        <a href="produto-unico?id=<?php echo $produto['id']; ?>" style="text-decoration: none; color: inherit;">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <p><?php echo htmlspecialchars($produto['description'] ? substr($produto['description'], 0, 50) . '...' : 'Produto em couro legítimo'); ?></p>
                                    <div class="price">
                                        <?php if ($produto['oldPrice']): ?>
                                            <span class="old-price">R$ <?php echo number_format($produto['oldPrice'], 2, ',', '.'); ?></span>
                                            <span class="new-price">R$ <?php echo number_format($produto['price'], 2, ',', '.'); ?></span>
                                        <?php else: ?>
        ...
        <div class="container">
            <div class="sienna-content">
                <div class="sienna-image">
                    <img src="<?php echo htmlspecialchars($secao_destacada['imagem']); ?>" alt="<?php echo htmlspecialchars($secao_destacada['titulo']); ?>">
                </div>
                <div class="sienna-text">
                    ...
                    <button class="purchase-button" onclick="window.location.href='produto-unico?id=<?php echo $secao_destacada['produto_id']; ?>'">Compre Já</button>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <?php foreach ($recentProducts as $produto): ?>
                            <a href="produto-unico?id=<?php echo $produto['id']; ?>" style="text-decoration: none; color: inherit;">
                                <div class="product-card">
                                    ...
                                    <div class="product-info">
                                        <h3><?php echo htmlspecialchars($produto['title']); ?></h3>
                                        <p><?php echo htmlspecialchars($produto['description'] ? substr($produto['description'], 0, 50) . '...' : 'Produto em couro legítimo artesanal'); ?></p>
                                        <div class="price">
            ...
            <div class="testimonials-grid">
                ...
                if (empty($avaliacoes_ativas)): ?>
                    ...
                    <div class="testimonial-card">
                        ...
                        <p>"Trabalhamos com paixão para oferecer os melhores produtos em couro legítimo. Sua satisfação é nossa prioridade!"</p>
                    </div>
                <?php else: ?>
