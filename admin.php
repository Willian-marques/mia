...
<head>
    ...
    * {
    ...
    .messages-card, .new-messages-card {
        cursor: pointer;
        transition: var(--transition);
        border-radius: var(--border-radius);
        overflow: hidden;
    ...
    .messages-card::before, .new-messages-card::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
    ...
    .messages-card:hover::before, .new-messages-card:hover::before {
        opacity: 1;
    }

    .messages-card:hover, .new-messages-card:hover {
...
<body>
    ...
    <div class="admin-layout">
        ...
        <?php if (isset($success_message)): ?>
            <div style="background: var(--white); color: var(--primary); padding: 20px; border-radius: var(--border-radius-sm); margin-bottom: 30px; border: 2px solid var(--success); text-align: center;">
        ...
        <div id="dashboard" style="margin-bottom: 40px;">
            <h2 style="color: var(--primary); font-size: 32px; font-weight: 700; margin-bottom: 8px; letter-spacing: -1px;">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <h3><?php echo count(array_filter(getAllProdutos(), function($p) { return $p['status'] === 'ativo'; })); ?>
                </h3>
                <p>Produtos Ativos</p>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <h3><?php echo count(array_filter(getAllProdutos(), function($p) { return !empty($p['oldPrice']); })); ?>
                </h3>
        ...
        <div class="messages-section" style="margin-top: 40px;">
            <div class="table-header">
                ...
                <div style="display: flex; gap: 15px; align-items: center;">
                    <a href="admin-mensagens" class="btn-secondary" target="_blank" style="text-decoration: none;">
            ...
            <?php if ($mensagens_stats['total'] > 0): ?>
                ...
                function getStatusColorAdmin($status) {
                    switch($status) {
                        case 'nova': return '#dc2626';
                        case 'lida': return '#f59e0b'; 
                    ...
                    <?php foreach ($mensagens_recentes as $msg): ?>
                        ...
                        ">
                            ...
                            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                ...
                                <?php endif; ?>
                                <form method="POST" action="delete-message.php" style="display: inline;" onsubmit="return confirm('Tem certeza que deseja excluir esta mensagem? Esta ação não pode ser desfeita.')">
                                    <input type="hidden" name="message_id" value="<?php echo $msg['id']; ?>">
                                    <button type="submit" style="background: #dc2626; color: white; padding: 6px 12px; border-radius: 4px; border: none; cursor: pointer; font-size: 12px;">
                                        Excluir
                                    </button>
                                </form>
                            </div>
        ...
        <div class="featured-product-section glass-card" style="margin-top: 40px;">
            ...
            <div style="background: var(--white); border-radius: 0 0 var(--border-radius-sm) var(--border-radius-sm); padding: 30px; margin-top: 0; border: 2px solid var(--secondary); border-top: none;">
                <form method="POST" style="display: grid; gap: 25px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 15px; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-weight: 500;">
                            <input type="checkbox" name="destaque_ativo" <?php echo $produto_destaque['ativo'] ? 'checked' : ''; ?> 
                                   style="width: 20px; height: 20px; accent-color: #520100;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                        <!-- Título -->
                        <div>
                            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--primary);">
                        ...
                        <div>
                            ...
                            <select name="destaque_produto_id" style="width: 100%; padding: 14px 16px; background: var(--white); border: 2px solid var(--secondary); border-radius: var(--border-radius-sm); font-size: 16px; color: var(--primary); transition: all 0.3s;">
                                <option value="">Selecione um produto</option>
                                <?php foreach (getAllProdutos() as $produto): ?>
                                    <option value="<?php echo $produto['id']; ?>" 
                                            <?php echo $produto_destaque['produto_id'] == $produto['id'] ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars($produto['title']); ?> - R$ <?php echo number_format($produto['price'], 2, ',', '.'); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <!-- Informações -->
                    <div style="background: var(--white); border-left: 4px solid var(--secondary); padding: 20px; border-radius: var(--border-radius-sm); margin-top: 25px; border: 2px solid var(--secondary);">
                        <h4 style="margin: 0 0 15px 0; color: var(--primary); display: flex; align-items: center; gap: 10px;">
                    ...
                    <!-- Botão Salvar -->
                    <div style="text-align: center; padding-top: 30px; border-top: 2px solid var(--secondary); margin-top: 30px;">
                        <button type="submit" style="
                            ...
                            gap: 10px;
                            margin: 0 auto;
                        " onmouseover="this.style.transform='translateY(-2px)'; this.style.background='var(--primary)'" onmouseout="this.style.transform='translateY(0)'; this.style.background='var(--secondary)'">
                                        ...
                                        <div>
                                            <h4 style="margin: 0; font-size: 16px; color: #520100;">
                                                ...
                                                <?php if (!$avaliacao['ativo']): ?>
                                                    <span style="background: #dc3545; color: white; padding: 2px 6px; border-radius: 10px; font-size: 10px; margin-left: 8px;">INATIVO</span>
                                                <?php endif; ?>
                                            </h4>
                                            <div style="margin: 5px 0;">
                                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                                    <span style="color: <?php echo $i <= $avaliacao['estrelas'] ? '#ffc107' : '#e9ecef'; ?>; font-size: 16px;">★</span>
                                                <?php endfor; ?>
                                            </div>
                                            <small style="color: #666;">
                                                Produto: <?php echo htmlspecialchars($avaliacao['produto_relacionado']); ?> | 
                                                Criado: <?php echo date('d/m/Y', strtotime($avaliacao['data_criacao'])); ?>
                                            </small>
                                        </div>
                                    </div>
                                    
                                    <div style="background: white; padding: 15px; border-radius: 8px; margin-bottom: 15px; border-left: 4px solid #520100;">
                ...
                <form id="reviewForm" method="POST">
                    ...
                    <div style="margin-bottom: 25px; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" id="reviewAtivo" name="review_ativo" checked style="width: 20px; height: 20px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <!-- Nome -->
                        <div>
                            <label style="display: block; margin-bottom: 8px; font-weight: 500;">Nome do Cliente *</label>
                        ...
                        <!-- Estrelas -->
                        <div>
                            <label style="display: block; margin-bottom: 8px; font-weight: 500;">Avaliação (estrelas) *</label>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 12px; font-weight: 500;">Avatar do Cliente</label>
                        
                        <!-- Radio para escolher tipo de foto -->
                        <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="radio" name="foto_tipo" value="iniciais" checked onchange="toggleFotoOptions()">
                                <span>Usar iniciais do nome</span>
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="radio" name="foto_tipo" value="upload" onchange="toggleFotoOptions()">
                        ...
                        <div id="uploadSection" style="display: none;">
                            ...
                            <div id="avatarPreview" style="display: none; text-align: center; margin-top: 15px;">
                    ...
                    <!-- Produto Relacionado -->
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; font-weight: 500;">Produto Relacionado</label>
                    ...
                    <!-- Texto da Avaliação -->
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; font-weight: 500;">Depoimento *</label>
                ...
                <form id="productForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="productDescription" name="productDescription" required
                            placeholder="Descreva as principais características do produto..." rows="4"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="productSpecifications" name="productSpecifications" required
                            ...
                            rows="4"></textarea>
                        <small style="color: #666; font-size: 12px;">Separe cada especificação com "|" (pipe). Ex:
                            Material: Couro|Cor: Marrom|Peso: 200g</small>
                    </div>

                    <div class="form-group">
                        <label for="productPrice">Preço do Produto - Original (R$) *</label>
                        <input type="number" id="productPrice" name="productPrice" step="0.01" required min="0.01">
                        <small style="color: #666; font-size: 12px;">Preço padrão do produto (sem desconto)</small>
                    </div>
                    ...
                    <div class="discount-section">
                        <div class="section-header">
                            ...
                            <small style="color: #666; font-size: 12px;">Configure o preço promocional para ativar o desconto</small>
                        </div>
                        ...
                        <div id="discountSection" class="discount-fields" style="display: none;">
                            <div class="form-row">
                                <div class="form-col">
                                    <div class="form-group">
                                        <label for="productOldPrice">Preço com Desconto - Promocional (R$) *</label>
                                        <input type="number" id="productOldPrice" name="productOldPrice" step="0.01"
                                            min="0.01" placeholder="Ex: 150.00">
                                        <small style="color: #666; font-size: 12px;">Preço promocional que o cliente irá pagar</small>
                                    </div>
                                </div>
                                <div class="form-col">
                                    <div class="form-group">
                    ...
                    <div class="colors-section">
                        ...
                        <p class="colors-hint"><strong>Clique nas cores</strong> para selecionar múltiplas opções
                    ...
                    <div class="form-group">
                        ...
                        <div id="imageHelp" style="margin-top: 10px;">
                            <small style="color: #666; font-size: 12px;">
                                <strong>Para produtos existentes:</strong> As imagens atuais serão mantidas. 
                                Você pode adicionar novas imagens ou remover as existentes conforme necessário.
                            </small>
                        </div>
                        <div id="imageError" style="color: #e74c3c; font-size: 14px; margin-top: 8px; display: none;">
    ...
    function editProduct(id) {
        ...
        fetch(`admin_actions.php?action=get&productId=${id}`)
            ...
            .then(text => {
                console.log('Get product response:', text);
                try {
                    ...
                    if (data.success) {
                        ...
                        notifications.error('Erro ao Carregar', 'Não foi possível carregar os dados do produto: ' + data.error);
                    }
                } catch (e) {
    ...
    function saveProduct() {
        ...
        if (!currentProductId && selectedImages.length === 0) {
            ...
            return;
        } else if (currentProductId && selectedImages.length === 0 && (!window.existingImages || window.existingImages.length === 0)) {
        ...
        fetch('admin_actions.php', {
            ...
            .then(text => {
                ...
                try {
                    ...
                    console.error('JSON Parse Error:', e);
                    notifications.error('Erro de Servidor', 'Resposta inválida do servidor. Verifique o console para detalhes.');
                }
            })
            .catch(error => {
                console.error('Fetch Error:', error);
                notifications.error('Erro de Conexão', 'Não foi possível conectar ao servidor. Verifique se o XAMPP está rodando.');
            })
            .finally(() => {
        ...
        if (confirm('Tem certeza que deseja excluir este produto?\n\nEsta ação não pode ser desfeita!')) {
            ...
            fetch('admin_actions.php', {
                ...
                .catch(error => {
                    ...
                    notifications.error('Erro de Conexão', 'Não foi possível excluir o produto. Verifique a conexão.');
                });
        }
    }
    ...
    document.getElementById('productImages').addEventListener('change', function(e) {
        ...
        files.forEach(file => {
            if (file.type.startsWith('image/') && file.size <= 5 * 1024 * 1024) {
                ...
                notifications.warning('Arquivo Inválido', `O arquivo "${file.name}" não é válido. Apenas imagens até 5MB são permitidas.`);
            }
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDestaquePreview() {
            ...
            const botaoTexto = document.querySelector('input[name="destaque_botao_texto"]')?.value || 'Ver Produto';
            const corFundo = document.querySelector('input[name="destaque_cor_fundo"]')?.value || '#520100';
            const corTexto = document.querySelector('input[name="destaque_cor_texto"]')?.value || '#ffffff';
