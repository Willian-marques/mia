...
if ($logged_in) {
    ...
    if ($logged_in) {
        ...
        switch (true) {
            ...
            case $rota === '':
                $dashboard_file = $BASE . '/admin/dashboard.php';
                if (file_exists($dashboard_file)) {
                    include $dashboard_file;
                } else {
                    echo '<h2>Dashboard do Administrador</h2><p>Bem-vindo ao painel administrativo.</p>';
                }
                break;
            ...
            default:
                ...
                echo "<a href='./admin.php'>Voltar para o painel</a>";
                break;
        }
    }
