                        ...
                        <form method="POST" style="display: grid; gap: 25px;">
                            ...
                            <div
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="destaque_ativo"
                                        <?php echo $produto_destaque['ativo'] ? 'checked' : ''; ?>
...
<<<<<<< HEAD
                                ...
                                const hasColorImages = product.colorImages && Object.keys(product.colorImages)
                                    .length > 0;
                                ...
                                if (hasColorImages) {
                                    ...
                                    Object.entries(product.colorImages).forEach(([colorName, images]) => {
                                        window.colorImages[colorName] = images.map(img =>
                                        img); // Strings de path
                                    });
...
>>>>>>> fd76700d03042fe3a3ee44d037f6896c2f3d808e
                    ...
                    .catch(error => {
                        ...
                        alert(mensagem);
                        notifications.error('Erro ao Carregar',
                            'Não foi possível carregar os dados do produto. Verifique o console para mais detalhes.'
                            );
                    });
            }
